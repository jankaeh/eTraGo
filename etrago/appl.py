...
#==============================================================================
    ...
    if args['lines_extendable']:
        ...
        np.savetxt('list_lines_opt_2nd2days.csv',list_lines_opt, delimiter=",")
        np.savetxt('list_transformers_opt_2nd2days.csv',list_transformers_opt, delimiter=",")
